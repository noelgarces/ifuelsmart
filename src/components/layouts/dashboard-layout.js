              ...
              >
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    ...
                    />
                    <path
                      className={`fill-current text-gray-600 ${page === "" && "text-indigo-600"}`}
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === "customers" && "bg-gray-900"}`}>
              ...
              >
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    <path
                      className={`fill-current text-gray-400 ${page === "customers" && "text-indigo-300"}`}
                      d="M7 0l6 7H8v10H6V7H1z"
                    />
                    <path
                      className={`fill-current text-gray-600 ${page === "customers" && "text-indigo-500"}`}
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-gray-400 ${page === "orders" && "text-indigo-300"}`}
                        d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                      />
                      <path
                        className={`fill-current text-gray-700 ${page === "orders" && "text-indigo-600"}`}
                        d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                      />
                      <path
                        className={`fill-current text-gray-600 ${page === "orders" && "text-indigo-500"}`}
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === "messages" && "bg-gray-900"}`}>
              ...
              >
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    <path
                      className={`fill-current text-gray-600 ${page === "messages" && "text-indigo-500"}`}
                      d="M14.5 7c4.695 0 8.5 3.184 8.5 7.111 0 1.597-.638 3.067-1.7 4.253V23l-4.108-2.148a10 10 0 01-2.692.37c-4.695 0-8.5-3.184-8.5-7.11C6 10.183 9.805 7 14.5 7z"
                    />
                    <path
                      className={`fill-current text-gray-400 ${page === "messages" && "text-indigo-300"}`}
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === "applications" && "bg-gray-900"}`}>
              ...
              >
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    <circle
                      className={`fill-current text-gray-400 ${page === "applications" && "text-indigo-300"}`}
                      cx="18.5"
                      cy="5.5"
                      r="4.5"
                    />
                    <circle
                      className={`fill-current text-gray-600 ${page === "applications" && "text-indigo-500"}`}
                      cx="5.5"
                      cy="5.5"
                      r="4.5"
                    />
